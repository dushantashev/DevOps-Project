...
public class NationalParkController {
    ...
    public final NationalParkService nationalParkService;
    public final ParkLocationService parkLocationService;
    ...
    public String listAll(@RequestParam(required = false) String name,
        ...
        model.addAttribute("locations",this.parkLocationService.listAll());
        model.addAttribute("nationalParks", page.getContent());
...
//        model.addAttribute("bodyContent", "products");
    ...
    public String showAdd(Model model) {
        model.addAttribute("locations",this.parkLocationService.listAll());
        model.addAttribute("parkTypes", ParkType.values());
        model.addAttribute("nationalParks", this.nationalParkService.listAll());
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id,Model model) {
        NationalPark nationalPark=nationalParkService.findById(id);
        model.addAttribute("park",nationalPark);
        model.addAttribute("parkTypes", ParkType.values());
        model.addAttribute("locations",this.parkLocationService.listAll());
        model.addAttribute("nationalParks", this.nationalParkService.listAll());
